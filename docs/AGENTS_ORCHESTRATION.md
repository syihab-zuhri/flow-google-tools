...
### Langkah Selanjutnya
Silakan berikan persetujuan untuk penulisan file `AGENTS.md` pada jalur `/mnt/d/project gabut/tolls flow/AGENTS.md`, atau Anda dapat langsung menyalin isi blok di atas ke lokasi berkas tersebut.
